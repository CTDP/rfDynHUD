...
import net.ctdp.rfdynhud.properties.PercentageProperty;
 ...
 */
public class PercentageCellEditor extends ValueCellEditor<Property, JPanel, JTextField>
{
    ...
    {
        return ( PercentageProperty.parseValue( textfield.getText() ) * 100f );
    }
