...
class _rf1_VehicleInfo extends VehicleInfo
{
    /**
     * {@inheritDoc}
     */
    ...
    protected void reload( LiveGameData gameData ) throws IOException
    {
        ...
        java.io.File playerVEHFile = ( (_rf1_ProfileInfo)gameData.getProfileInfo() ).getVehicleFile();
        ...
        if ( ( playerVEHFile != null ) && playerVEHFile.exists() )
        {
            ...
            new _rf1_VehicleInfoParser( playerVEHFile.getAbsolutePath(), (_rf1_VehicleInfo)gameData.getVehicleInfo() ).parse( playerVEHFile );
        }
    }
