 ...
 */
class _rf1_WeatherInfo extends WeatherInfo
{
    private final _rf1_ScoringInfo scoringInfo;
    ...
    _rf1_WeatherInfo( LiveGameData gameData )
    {
        super( gameData );
        
        this.scoringInfo = (_rf1_ScoringInfo)gameData.getScoringInfo();
    }
}
