...
import net.ctdp.rfdynhud.gamedata.rfactor1._rf1_VehiclePhysics._rf1_TireCompound;
...
class _rf1_VehicleSetup extends VehicleSetup
{
    ...
    */
     ...
     * @author Marvin Froehlich (CTDP)
     */
    public static class _rf1_General extends General
    {
        ...
        */
        ...
        _rf1_TireCompound frontTireCompound; // GENERAL::FrontTireCompoundSetting=7//04-Hot
        _rf1_TireCompound rearTireCompound; // GENERAL::RearTireCompoundSetting=7//04-Hot
        ...
        */
         ...
         */
        @Override
        public final _rf1_TireCompound getFrontTireCompound()
        {
         ...
         */
        @Override
        public final _rf1_TireCompound getRearTireCompound()
        {
    ...
    final _rf1_General general = new _rf1_General();
    
    /**
     * {@inheritDoc}
     */
    @Override
    public final _rf1_General getGeneral()
    {
        return ( general );
    }
    
    private static class _rf1_Suspension
    {
        ...
        public static class _rf1_ThirdSpring
        {
            private MeasurementUnits measurementUnits = MeasurementUnits.METRIC;
        ...
        private final _rf1_ThirdSpring front3rdSpring = new _rf1_ThirdSpring();
        private final _rf1_ThirdSpring rear3rdSpring = new _rf1_ThirdSpring();
         ...
         */
        public final _rf1_ThirdSpring getFront3dSpring()
        {
         ...
         */
        public final _rf1_ThirdSpring getRear3dSpring()
        {
    ...
    private final _rf1_Suspension suspension = new _rf1_Suspension();
    
    /*
     * {@inheritDoc}
     *
    @Override
    public final _rf1_Suspension getSuspension()
    {
        return ( suspension );
    }
    */
     ...
     */
    public static class _rf1_Controls extends Controls
    {
    ...
    final _rf1_Controls controls = new _rf1_Controls();
    
    /**
     * {@inheritDoc}
     */
    @Override
    public final _rf1_Controls getControls()
    {
        return ( controls );
    }
    ...
    final _rf1_Engine engine = new _rf1_Engine();
    ...
    private static class _rf1_GearBox
    {
    ...
    //private final _rf1_GearBox gearBox = new _rf1_GearBox();
    
    /*
     * 
     * @return an interface to the settings of the gear box.
     *
    public final _rf1_GearBox getGearBox()
    {
        return ( gearBox );
    }
    */
    
    private static class _rf1_Differential
    {
    ...
    //private final _rf1_Differential differential = new _rf1_Differential();
    
    /*
     * @return an interface to the settings of the differential.
     *
    public final _rf1_Differential getDifferential()
    {
        return ( differential );
    }
    */
     ...
     * @author Marvin Froehlich
     */
    public static class _rf1_WheelAndTire extends WheelAndTire
    {
        private MeasurementUnits measurementUnits = MeasurementUnits.METRIC;
        ...
        */
        ...
        _rf1_WheelAndTire( Wheel wheel )
        {
            super( wheel );
        }
    }
    
    final _rf1_WheelAndTire flWheelAndTire = new _rf1_WheelAndTire( Wheel.FRONT_LEFT );
    final _rf1_WheelAndTire frWheelAndTire = new _rf1_WheelAndTire( Wheel.FRONT_RIGHT );
    final _rf1_WheelAndTire rlWheelAndTire = new _rf1_WheelAndTire( Wheel.REAR_LEFT );
    final _rf1_WheelAndTire rrWheelAndTire = new _rf1_WheelAndTire( Wheel.REAR_RIGHT );
    
    /**
     * {@inheritDoc}
     */
    @Override
    public final _rf1_WheelAndTire getWheelAndTire( Wheel wheel )
    {
        switch ( wheel )
        {
            case FRONT_LEFT:
    ...
    protected boolean checkLoadPhysicsAndSetupOnSessionStarted( LiveGameData gameData, boolean isEditorMode )
    {
        ...
        if ( isEditorMode )
        {
            File cchFile = ( (_rf1_ProfileInfo)gameData.getProfileInfo() ).getCCHFile();
            File playerVEHFile = ( (_rf1_ProfileInfo)gameData.getProfileInfo() ).getVehicleFile();
