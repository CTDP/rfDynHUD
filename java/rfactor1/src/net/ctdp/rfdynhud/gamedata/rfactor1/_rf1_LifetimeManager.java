...
class _rf1_LifetimeManager implements TelemetryData.TelemetryDataUpdateListener
{
    public static final _rf1_LifetimeManager INSTANCE = new _rf1_LifetimeManager();
     ...
     */
    private void applyWearValues( _rf1_TelemetryData telemData, ScoringInfo scoringInfo )
    {
    ...
    public void onTelemetryDataUpdated( LiveGameData gameData, boolean isEditorMode )
    {
        ...
        final _rf1_TelemetryData telemData = (_rf1_TelemetryData)gameData.getTelemetryData();
