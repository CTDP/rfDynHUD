...
class _rf2_VehiclePhysics extends VehiclePhysics
{
    ...
    private final _rf2_Engine engine = new _rf2_Engine();
     ...
     * @author Marvin Froehlich (CTDP)
     */
    public static class _rf2_Brakes extends Brakes
    {
         ...
         * @author Marvin Froehlich (CTDP)
         */
        public static class _rf2_WheelBrake extends WheelBrake
        {
    		...
    		_rf2_WheelBrake( Wheel wheel )
    		{
    		    super( wheel );
    		}
        }
        
        private final _rf2_WheelBrake brakeFrontLeft = new _rf2_WheelBrake( Wheel.FRONT_LEFT );
        private final _rf2_WheelBrake brakeFrontRight = new _rf2_WheelBrake( Wheel.FRONT_RIGHT );
        private final _rf2_WheelBrake brakeRearLeft = new _rf2_WheelBrake( Wheel.REAR_LEFT );
        private final _rf2_WheelBrake brakeRearRight = new _rf2_WheelBrake( Wheel.REAR_RIGHT );
        
        /**
         * {@inheritDoc}
         */
        @Override
        public final _rf2_WheelBrake getBrake( Wheel wheel )
        {
            switch ( wheel )
            {
                case FRONT_LEFT:
    ...
    private final _rf2_Brakes brakes = new _rf2_Brakes();
    
    /**
     * {@inheritDoc}
     */
    @Override
    public final _rf2_Brakes getBrakes()
    {
        return ( brakes );
    }
     ...
     * @author Marvin Froehlich (CTDP)
     */
    public static class _rf2_TireCompound extends TireCompound
    {
        String name = "N/A";
        int index = -1;
        ...
        /**
         * Model of one wheel of a compound. There will always be one {@link _rf2_CompoundWheel} in a {@link _rf2_TireCompound} for each wheel of the vehicle.
         * 
         * @author Marvin Froehlich (CTDP)
         */
        public static class _rf2_CompoundWheel extends CompoundWheel
        {
            ...
            */
            ...
            _rf2_CompoundWheel( Wheel wheel )
            {
                super( wheel );
            }
        }
        
        private final _rf2_CompoundWheel frontLeft = new _rf2_CompoundWheel( Wheel.FRONT_LEFT );
        private final _rf2_CompoundWheel frontRight = new _rf2_CompoundWheel( Wheel.FRONT_RIGHT );
        private final _rf2_CompoundWheel rearLeft = new _rf2_CompoundWheel( Wheel.REAR_LEFT );
        private final _rf2_CompoundWheel rearRight = new _rf2_CompoundWheel( Wheel.REAR_RIGHT );
        
        /**
         * {@inheritDoc}
         */
        @Override
        public final _rf2_CompoundWheel getWheel( Wheel wheel )
        {
            switch ( wheel )
            {
                case FRONT_LEFT:
    ...
    private _rf2_TireCompound[] tireCompounds;
    private _rf2_TireCompound tcBestGripFrontLeft = null;
    private _rf2_TireCompound tcBestGripFrontRight = null;
    private _rf2_TireCompound tcBestGripRearLeft = null;
    private _rf2_TireCompound tcBestGripRearRight = null;
    
    void setTireCompounds( _rf2_TireCompound[] tireCompounds )
    {
     ...
     */
    @Override
    public final _rf2_TireCompound getTireCompound( int index )
    {
        if ( tireCompounds == null )
        {
     ...
     */
    @Override
    public final _rf2_TireCompound getTireCompoundBestGrip( Wheel wheel )
    {
        if ( tireCompounds == null )
            return ( FALLBACK_COMPOUND );
        ...
        float maxGrip = 0.0f;
        _rf2_TireCompound maxGripCompound = null;
        
        for ( int i = 0; i < tireCompounds.length; i++ )
        {
            _rf2_TireCompound._rf2_CompoundWheel tcw = tireCompounds[i].getWheel( wheel );
    ...
    public static class _rf2_UpgradeIdentifier extends UpgradeIdentifier
    {
        ...
        _rf2_UpgradeIdentifier( String upgradeType, String upgradeLevel, String description )
        {
    ...
    _rf2_UpgradeIdentifier[] installedUpgrades = null;
    
    /**
     * {@inheritDoc}
     */
    @Override
    public final _rf2_UpgradeIdentifier[] getInstalledUpgrades()
    {
        return ( installedUpgrades );
    }
    
    private static _rf2_TireCompound createDefaultCompound( String name, int index, float optTemp )
    {
        float optPress = 64.5f;
        float optPressMult = 0.018841f;
        
        _rf2_TireCompound tc = new _rf2_TireCompound();
    ...
    public static final _rf2_TireCompound FALLBACK_COMPOUND = createDefaultCompound( "DUMMY", 0, 96.5f );
    ...
    void loadDefaults()
    {
        try
        {
            ...
            _rf2_TireCompound[] tireCompounds = new _rf2_TireCompound[ 20 ];
