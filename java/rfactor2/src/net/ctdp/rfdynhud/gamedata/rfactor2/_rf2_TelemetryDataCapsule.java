 ...
 */
class _rf2_TelemetryDataCapsule extends _TelemetryDataCapsule
{
    ...
    public final float getLongitudinalAcceleration()
    {
        ...
        return ( -(float)ByteUtil.readDouble( buffer, OFFSET_LOCAL_ACCELERATION + 2 * ByteUtil.SIZE_FLOAT ) );
    }
    ...
    public final float getLateralAcceleration()
    {
        ...
        return ( (float)ByteUtil.readDouble( buffer, OFFSET_LOCAL_ACCELERATION + 0 * ByteUtil.SIZE_FLOAT ) );
    }
    ...
    public final float getTireTemperature( Wheel wheel, WheelPart part )
    {
        ...
        {
            case FRONT_LEFT:
                return ( (float)ByteUtil.readDouble( buffer, OFFSET_WHEEL_DATA + 0 * WHEEL_DATA_SIZE + OFFSET_TIRE_TEMPERATURES + part.getArrayIndexFL() * ByteUtil.SIZE_FLOAT ) );
            case FRONT_RIGHT:
                return ( (float)ByteUtil.readDouble( buffer, OFFSET_WHEEL_DATA + 1 * WHEEL_DATA_SIZE + OFFSET_TIRE_TEMPERATURES + part.getArrayIndexFR() * ByteUtil.SIZE_FLOAT ) );
            case REAR_LEFT:
                return ( (float)ByteUtil.readDouble( buffer, OFFSET_WHEEL_DATA + 2 * WHEEL_DATA_SIZE + OFFSET_TIRE_TEMPERATURES + part.getArrayIndexRL() * ByteUtil.SIZE_FLOAT ) );
            case REAR_RIGHT:
                return ( (float)ByteUtil.readDouble( buffer, OFFSET_WHEEL_DATA + 3 * WHEEL_DATA_SIZE + OFFSET_TIRE_TEMPERATURES + part.getArrayIndexRR() * ByteUtil.SIZE_FLOAT ) );
        }
