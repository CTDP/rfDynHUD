...
{
    public static final InputAction TogglePlugin = new InputAction( "TogglePlugin", true, false );
    public static final InputAction ToggleWidgetVisibility = new InputAction( "ToggleWidgetVisibility", true );
    public static final InputAction IncBoost = new InputAction( "IncBoost", true, false );
    public static final InputAction DecBoost = new InputAction( "DecBoost", true, false );
    public static final InputAction TempBoost = new InputAction( "TempBoost", null, false );
